...
export default class LeftNav extends Component {
  ...
  _handleToggle = (openKeys) => {
    ...
    if (latestOpenKey) {
      ...
      console.log(this.getAncestorKeys(latestOpenKey))
      console.log(latestOpenKey)
