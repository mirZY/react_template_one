...
export const login = createAjaxAction(common.login, requestLogin, recevieLogin) //登录
export const fetchPassword =createAjaxAction(common.synUser, requestLogin, recevieLogin) //修改
